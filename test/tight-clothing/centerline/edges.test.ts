import { Edge } from "src/tight-clothing/centerline/edge";
import {
  createAllEdges,
  createEdgeMap,
  findNextEdge,
} from "src/tight-clothing/centerline/edges";
import { createRemainingVerticesMap } from "src/tight-clothing/centerline/vertices";
import {
  beforeEach,
  describe,
  expect,
