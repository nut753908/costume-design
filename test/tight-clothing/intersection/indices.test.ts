...
test("createVertexIndicesMap()", () => {
  ...
  expect(createVertexIndicesMap(nPolygonIndices)).toEqual(expected);
});

test("createEdgeIndicesMap()", () => {
  /**
   * flat layout:
   *   6 7 8
   *   3 4 5
  ...
  expect(createEdgeIndicesMap(nPolygonIndices)).toEqual(expected);
});
