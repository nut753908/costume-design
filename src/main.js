...
import { EdgeLoopStacks } from "./cross-section/edge-loop-stacks.js";
...
function init() {
  ...
  const edgeLoopStacks = new EdgeLoopStacks(
    group.children[0].children[1].geometry
  );
  console.log(edgeLoopStacks.toJSON());
