...
- TODO: add scene.png
- TODO: remove cylinder description
...
- TODO: add common > PlaneHelper
- TODO: add common > THREE.ArrowHelper
- TODO: add PlaneManager
- TODO: add Area
...
| ----body_(u=uniforms)   | The appearance of body object. This is an original mesh toon material created from a shader material.<br>Link: https://threejs.org/docs/#ShaderMaterial |
...
| ----area_(u=uniforms)   | The appearance of area object. This is an original mesh toon material created from a shader material. The folder structure is the same as "body_(u=uniforms)" above.<br>Link: https://threejs.org/docs/#ShaderMaterial |
